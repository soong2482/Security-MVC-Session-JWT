...
public class CustomAdminAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomAdminAuthenticationFilter(CustomSuccessHandler successHandler, CustomFailedHandler failureHandler, RefreshTokenService refreshTokenService, JwtService jwtService, SessionService sessionService) {
